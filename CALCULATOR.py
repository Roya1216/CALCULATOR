...
while True:
    ...
    if 0<op<5:
        print(" For operators 1 to 4 please enter your two number:")
        num1= int(input('num1='))
        num2= int(input('num2='))
        ...
        print(" For operators 5 to 9 please enter your one number:")
        num= int(input('num='))
        ...
        op == 10 
        print('The command you requested could not be found')
        break